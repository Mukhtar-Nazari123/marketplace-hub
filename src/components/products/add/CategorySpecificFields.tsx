      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <div className="md:col-span-2 space-y-2">
          ...
          <Textarea
            ...
            placeholder={isRTL ? 'مشخصات فنی را اینجا بنویسید...\nمثال:\n- پردازنده: ...\n- حافظه: ...\n- صفحه نمایش: ...' : 'Write technical specs here...\nExample:\n- Processor: ...\n- Memory: ...\n- Display: ...'}
            rows={4}
            className={cn(isRTL && "text-right")}
          />
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Card className="md:col-span-2 p-4 space-y-3 bg-muted/30">
          ...
          <div className="flex items-center gap-4">
            ...
            />
            <span className="text-sm text-muted-foreground">
              {attributes.assemblyRequired ? (isRTL ? 'بله، نیاز به مونتاژ دارد' : 'Yes, assembly required') : (isRTL ? 'خیر، آماده استفاده' : 'No, ready to use')}
            </span>
          </div>
        </Card>
      </div>
  ...
  const renderBeautyFields = () => (
    <div className="space-y-4">
      <div className="flex items-center gap-2 mb-4 text-primary">
        ...
        <span className="font-medium">{isRTL ? 'مشخصات زیبایی و بهداشت' : 'Beauty & Personal Care Specifications'}</span>
      </div>
