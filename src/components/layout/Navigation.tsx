          ...
          <div className="hidden lg:flex items-center flex-1">
            {navLinks.map((link) => (
              ...
              >
                ...
                <span className={`absolute bottom-0 w-full h-0.5 bg-cyan scale-x-0 group-hover:scale-x-100 transition-transform ${isRTL ? 'right-0 origin-right' : 'left-0 origin-left'}`} />
              </Link>
            ))}
          </div>
