...
const TopBar = () => {
  ...
  return (
    <>
      ...
      <div className="lg:hidden px-1 sm:px-1.5 w-full overflow-hidden" dir={isRTL ? "rtl" : "ltr"}>
        <div className="bg-[#b6b6b6] px-2 sm:px-3 py-1.5 rounded-sm w-full overflow-hidden">
